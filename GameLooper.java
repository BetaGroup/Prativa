...
public class GameLooper extends JPanel implements Runnable, KeyListener {
    ...
    private double TimeTaken; //Kind of score for now
    ...
    private void gameRender() {
        ...
        g.drawString("Time Elapsed: " + TimeTaken, 700, 10);
        // draws player 
    ...
    public void run() {
        ...
        while (running) {
            ...
            scoreEndTime = System.nanoTime();
            scoreTimeElapsed = scoreEndTime - scoreStartTime;
            TimeTaken = (double) scoreTimeElapsed / 1000000000.0;
